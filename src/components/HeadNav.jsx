      ...
      <Modal active={modalActive} setActive={setModalActive}>
        <div className="TitleCart__Wrapper">
          ...
          <div className="Direction">
            ...
            <span className="Text1" onClick={() => dispatch(removeItems())}>
              отчистить корзину
            </span>
          </div>
        </div>
        ...
        <div className="Info_Wrapper">
          <div>
            <h5 className="Text2">
              Всего товаров: {totalLenght(cartItems.items)} шт.
            </h5>
          </div>
          <div>
            <h5 className="Text2">
              Сумма заказа: {totalPrice(cartItems.items)} ₽
            </h5>
          </div>
        </div>
        <div className="ButtonCart__Wrapper">
          <button className="Btn_3" onClick={() => setModalActive(false)}>
            {" "}
            Вернуться назад
          </button>
